...
def getNthSubkeyLetters(n,keyLength,message):
...
def hackVigenere(ciphertext):
	...
	if not SILENT_MODE:
		...
		for keyLength in allLikelyKeyLengths:
			keyLenthStr += ' '
			keyLenthStr += str(keyLength)
			print 'Kasiski Examination results say the most likely key lengths are: ' + keyLenthStr

	for keyLength in allLikelyKeyLengths:
		if not SILENT_MODE:
			print 'Attempting hack with key length ' + str(keyLength)
